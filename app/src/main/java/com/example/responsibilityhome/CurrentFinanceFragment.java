...
public class CurrentFinanceFragment extends Fragment {

    private static final String TAG = "현재재정수준";
     ...
     */
    public static CurrentFinanceFragment newInstance() {
        return new CurrentFinanceFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_current_finance, container, false);
